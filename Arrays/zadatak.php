...
echo "<br><h2>Provjera postoji li u nizu treći element te ispis pomoću var_dump().<br> Rezultat će se ispisati ovisno sadržava li niz traženu vrijednost true/false </h2>";
